...
return [
    'core' => [
        ...
        // Fractal
        base_path('vendor/league/fractal/src/ParamBag.php'),
        base_path('vendor/league/fractal/src/Serializer/JsonApiSerializer.php'),
        base_path('vendor/league/fractal/src/Serializer/DataArraySerializer.php'),
        base_path('vendor/league/fractal/src/Serializer/SerializerAbstract.php'),
        base_path('vendor/league/fractal/src/Pagination/CursorInterface.php'),
        base_path('vendor/league/fractal/src/Pagination/PaginatorInterface.php'),
        base_path('vendor/league/fractal/src/Pagination/IlluminatePaginatorAdapter.php'),
        base_path('vendor/league/fractal/src/Pagination/ZendFrameworkPaginatorAdapter.php'),
        base_path('vendor/league/fractal/src/Pagination/PagerfantaPaginatorAdapter.php'),
        base_path('vendor/league/fractal/src/Pagination/Cursor.php'),
        base_path('vendor/league/fractal/src/Resource/ResourceAbstract.php'),
        base_path('vendor/league/fractal/src/Resource/Item.php'),
        base_path('vendor/league/fractal/src/Resource/ResourceInterface.php'),
        base_path('vendor/league/fractal/src/Resource/NullResource.php'),
        base_path('vendor/league/fractal/src/Scope.php'),
        base_path('vendor/league/fractal/src/TransformerAbstract.php'),

        // OAUTH2
        base_path('vendor/league/oauth2-server/src/Middleware/AuthorizationServerMiddleware.php'),
        base_path('vendor/league/oauth2-server/src/Middleware/ResourceServerMiddleware.php'),
        base_path('vendor/league/oauth2-server/src/CryptKey.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/AccessTokenRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/UserRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/ClientRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/AuthCodeRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/ScopeRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/RefreshTokenRepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/Repositories/RepositoryInterface.php'),
        base_path('vendor/league/oauth2-server/src/ResponseTypes/BearerTokenResponse.php'),
        base_path('vendor/league/oauth2-server/src/ResponseTypes/RedirectResponse.php'),
        base_path('vendor/league/oauth2-server/src/ResponseTypes/ResponseTypeInterface.php'),
        base_path('vendor/league/oauth2-server/src/AuthorizationServer.php'),
        base_path('vendor/league/oauth2-server/src/RequestTypes/AuthorizationRequest.php'),
        base_path('vendor/league/oauth2-server/src/Entities/TokenInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/AuthCodeTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/ClientTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/RefreshTokenTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/TokenEntityTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/EntityTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/Traits/AccessTokenTrait.php'),
        base_path('vendor/league/oauth2-server/src/Entities/UserEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/RefreshTokenEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/ClientEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/ScopeEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/AccessTokenEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/Entities/AuthCodeEntityInterface.php'),
        base_path('vendor/league/oauth2-server/src/ResourceServer.php'),
        base_path('vendor/league/oauth2-server/src/Grant/ImplicitGrant.php'),
        base_path('vendor/league/oauth2-server/src/Grant/RefreshTokenGrant.php'),
        base_path('vendor/league/oauth2-server/src/Grant/ClientCredentialsGrant.php'),
        base_path('vendor/league/oauth2-server/src/Grant/PasswordGrant.php'),
        base_path('vendor/league/oauth2-server/src/Grant/AuthCodeGrant.php'),
        base_path('vendor/league/oauth2-server/src/AuthorizationValidators/AuthorizationValidatorInterface.php'),
        base_path('vendor/league/oauth2-server/src/AuthorizationValidators/BearerTokenValidator.php'),
        base_path('vendor/league/oauth2-server/src/Exception/OAuthServerException.php'),
        base_path('vendor/league/oauth2-server/src/Exception/UniqueTokenIdentifierConstraintViolationException.php'),
        base_path('vendor/league/oauth2-server/src/CryptTrait.php'),
        base_path('vendor/league/oauth2-server/src/RequestEvent.php'),

        // Passport
        base_path('vendor/laravel/passport/src/TokenRepository.php'),
        base_path('vendor/laravel/passport/src/RouteRegistrar.php'),
        base_path('vendor/laravel/passport/src/Client.php'),
        base_path('vendor/laravel/passport/src/Console/ClientCommand.php'),
        base_path('vendor/laravel/passport/src/Console/KeysCommand.php'),
        base_path('vendor/laravel/passport/src/Console/InstallCommand.php'),
        base_path('vendor/laravel/passport/src/HasApiTokens.php'),
        base_path('vendor/laravel/passport/src/ApiTokenCookieFactory.php'),
        base_path('vendor/laravel/passport/src/Scope.php'),
        base_path('vendor/laravel/passport/src/PersonalAccessClient.php'),
        base_path('vendor/laravel/passport/src/AuthCode.php'),
        base_path('vendor/laravel/passport/src/Guards/TokenGuard.php'),
        base_path('vendor/laravel/passport/src/ClientRepository.php'),
        base_path('vendor/laravel/passport/src/Passport.php'),
        base_path('vendor/laravel/passport/src/PersonalAccessTokenResult.php'),
        base_path('vendor/laravel/passport/src/Token.php'),
        base_path('vendor/laravel/passport/src/Http/Middleware/CheckClientCredentials.php'),
        base_path('vendor/laravel/passport/src/Http/Middleware/CheckForAnyScope.php'),
        base_path('vendor/laravel/passport/src/Http/Middleware/CreateFreshApiToken.php'),
        base_path('vendor/laravel/passport/src/Http/Middleware/CheckScopes.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/AuthorizationController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/ClientController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/HandlesOAuthErrors.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/AccessTokenController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/RetrievesAuthRequestFromSession.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/TransientTokenController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/PersonalAccessTokenController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/DenyAuthorizationController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/ApproveAuthorizationController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/AuthorizedAccessTokenController.php'),
        base_path('vendor/laravel/passport/src/Http/Controllers/ScopeController.php'),
        base_path('vendor/laravel/passport/src/PassportServiceProvider.php'),
        base_path('vendor/laravel/passport/src/PersonalAccessTokenFactory.php'),
        base_path('vendor/laravel/passport/src/Bridge/User.php'),
        base_path('vendor/laravel/passport/src/Bridge/PersonalAccessGrant.php'),
        base_path('vendor/laravel/passport/src/Bridge/RefreshToken.php'),
        base_path('vendor/laravel/passport/src/Bridge/FormatsScopesForStorage.php'),
        base_path('vendor/laravel/passport/src/Bridge/Client.php'),
        base_path('vendor/laravel/passport/src/Bridge/AccessToken.php'),
        base_path('vendor/laravel/passport/src/Bridge/Scope.php'),
        base_path('vendor/laravel/passport/src/Bridge/AuthCode.php'),
        base_path('vendor/laravel/passport/src/Bridge/AuthCodeRepository.php'),
        base_path('vendor/laravel/passport/src/Bridge/ScopeRepository.php'),
        base_path('vendor/laravel/passport/src/Bridge/ClientRepository.php'),
        base_path('vendor/laravel/passport/src/Bridge/UserRepository.php'),
        base_path('vendor/laravel/passport/src/Bridge/RefreshTokenRepository.php'),
        base_path('vendor/laravel/passport/src/Bridge/AccessTokenRepository.php'),
        base_path('vendor/laravel/passport/src/TransientToken.php'),

        // Lumen Passport
        base_path('vendor/dusterio/lumen-passport/src/LumenPassport.php'),
        base_path('vendor/dusterio/lumen-passport/src/Console/Commands/Purge.php'),
        base_path('vendor/dusterio/lumen-passport/src/Http/Controllers/AccessTokenController.php'),
        base_path('vendor/dusterio/lumen-passport/src/PassportServiceProvider.php'),
    ],
];
